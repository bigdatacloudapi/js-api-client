...
1. Include the CDN script tag `<script src="https://cdn.jsdelivr.net/gh/bigdatacloudapi/js-api-client/bigdatacloud_api_client.min.js" type="text/javascript"></script>` before your code execution
...
```javascript
<script src="https://cdn.jsdelivr.net/gh/bigdatacloudapi/js-api-client/bigdatacloud_api_client.min.js" type="text/javascript"></script>
